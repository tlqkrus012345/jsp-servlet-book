...
<section class="container mt-3" style="max-width: 560px;">
    <form method="post" action="/users">
        ...
        <div class="form-group">
            ...
            <input class="form-control" id="userPassword" name="userPassword" placeholder="패스워드">
        </div>
        <div class="form-group">
            <label for="userNickName">낙네임</label>
            <input class="form-control" id="userNickName" name="userNickName" placeholder="닉네임">
        </div>
